...
instructor: ["Phil Reed, Mario Antonioletti, Nilani Ganeshwaran, Doug Lowe"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Aleksandra Nenadic", "Gina Pegu", "Peter Smyth", "Carlene Barton", "Rosalind Bell"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
